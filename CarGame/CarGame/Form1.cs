...
namespace CarGame
{
    public partial class GameForm : Form
    {
        ...
        private void SetGridHeader()
        {
             ...
             grdUser.AddColumn("user_name", "이름", 60, GridColumnStyle.Default, HiddenType.False, ReadOnlyType.NoEdit, GridMaskStyle.None);
             grdUser.AddColumn("user_count", "횟수", 60, GridColumnStyle.Default, HiddenType.False, ReadOnlyType.NoEdit, GridMaskStyle.None);
             grdUser.AddColumn("user_avg", "평균점수", 60, GridColumnStyle.Default, HiddenType.False, ReadOnlyType.NoEdit, GridMaskStyle.None);
             
             grdUser.SetGridHeader();
        }
        ...
        private void TmrMove_Tick(object sender, EventArgs e)
        {
            ...
            {
                CarLimit();
                // 부딛힌 장애물이 코인이라면 -> 코인이 없어지면서 점수가 올라간다
            }
        ...
        private void GameForm_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Left)
            {
                if (CarName == "롤스로이스")
                {
                    ...
                    picCar.Image = CarGame.Properties.Resources.롤스왼;
                    picCar.Left -= 25;
                }
                else if (CarName == "폭스바겐 티구안")
                {

                    picCar.Image = CarGame.Properties.Resources.티구안왼;
                    picCar.Left -= 10;
                }
                else if (CarName == "렉스턴 스포츠")
                {

                    picCar.Image = CarGame.Properties.Resources.렉스턴왼;
                    picCar.Left -= 5;
                }
            ...
            else if (e.KeyCode == Keys.Right)
            {
                if (CarName == "롤스로이스")
                {
                    ...
                    picCar.Image = CarGame.Properties.Resources.롤스오;
                    picCar.Left += 25;
                }
                else if (CarName == "폭스바겐 티구안")
                {

                    picCar.Image = CarGame.Properties.Resources.티구안오;
                    picCar.Left += 10;
                }
                else if (CarName == "렉스턴 스포츠")
                {

                    picCar.Image = CarGame.Properties.Resources.렉스턴오;
                    picCar.Left += 5;
                }
        ...
        private void CreateObstacle()
        {
            ...
            {
                bool coin = box.Image == CarGame.Properties.Resources.코인;
                // if (coin)
                // {
                //     _score += 2;
                //     image.coin.dispose();
        ...
        private void GetData2()
        {
            ...
            sb.AppendLine(" select             ");
            sb.AppendLine("  	user_name      ");
            sb.AppendLine("  ,	user_count     ");
            sb.AppendLine("  ,	user_avg       ");
            sb.AppendLine("                    ");
            sb.AppendLine(" from               ");
        ...
        private bool SavaData2()
        {
            ...
            sb.AppendLine(" insert into user_data                          ");
            sb.AppendLine(" (                                              ");
            sb.AppendLine(" 	user_name                                   ");
            sb.AppendLine(" , 	user_count                                  ");
            sb.AppendLine(" , 	user_avg                                    ");
            ...
            sb.AppendLine(" select                                         ");
            sb.AppendLine(" 	user_name	                                ");
            sb.AppendLine(" , 	count(user_name)                            ");
            sb.AppendLine(" , 	round(avg(user_score)::numeric,2)::varchar  ");
            sb.AppendLine(" from                                           ");
            sb.AppendLine(" 	car_game                                    ");
            sb.AppendLine(" group by                                       ");
            sb.AppendLine(" 	user_name                                   ");
